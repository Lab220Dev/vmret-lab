...
const adicionarFuncionario = async () => {
    ...
    try {
        await axios.post('/funcionarios/adicionar', data, {
                        ...
                        <div class="card">
                            ...
                            <div class="p-fluid formgrid grid">
                                <div class="static align-content-end flex-wrap field lg:col-4 md:col-6 sm:col-4">
                                    ...
                                    <FileUpload mode="basic" name="demo[]" url="demo/images" accept="image/*" :maxFileSize="1000000" @upload="onUpload" chooseLabel="Escolha uma Foto" />
                                </div>
                                ...
                                <div class="lg:col-8 md:col-6 sm:col-4">
                                    ...
                                    <div id="fim" class="flex align-content-end flex-wrap">
                                        <div class="m-2 flex align-items-end">
                                            <Checkbox v-model="funcionario.segunda" inputId="Segunda" name="pizza" value="Segunda" :binary="true" />
                            ...
                            <div class="col-12">
                                <TabView>
                                    ...
                                    <TabPanel header="Items do Funcionario">
                                        ...
                                        <DataTable :value="funcionario.itemsSelecionadosFuncionario" tableStyle="min-width: 50rem" stripedRows dataKey="sku">
                                            <Column field="name" header="Nome"></Column>
                                            <Column field="sku" header="SKU"></Column>
                                            <Column field="quantidade" header="Quantidade"></Column>
