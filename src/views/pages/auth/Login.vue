...
<template>
        ...
        <SplitterPanel class="colunaesquerda flex-column h-screen justify-content-center align-items-center text-left m-0" :size="65">
            <div class="flex align-items-center">
                ...
                <div class="block justify-content-center">
                    <h1 class="align-items-center justify-content-center text-800 font-italic m-0">VM<span class="font-bold text-red-600 mt-0 mb-0">WEB</span></h1>
    ...
    <SplitterPanel class="flex colunadireita flex-column h-screen justify-content-between bg-white" :size="35" :minSize="30">
            ...
            <div>
                <p class="text-color-secondary text-sm">Visite nosso site <a href="https://www.lab220.com.br/" class="text-red-500 font-semibold hover:text-orange-500">lab220.com.br</a></p>
            </div>
        </SplitterPanel>
        </Splitter> 
</template>
