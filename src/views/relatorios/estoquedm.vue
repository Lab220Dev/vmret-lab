...
<template>
    <div class="card vh">
        ...
        <div class="my-2">
            ...
            <Select id="dm" filter style="width: 200px" panelStyle="width: 200px;" v-model="relatorio.id_dm" :options="dms" ref="select1" optionLabel="label" optionValue="value" :placeholder="$t('all')" class="mb-2 ml-2" @change="relatorioDM()" />
        </div>
