...
const retiradas = ref(
    [
        { id: 1, nome: 'Yorgo Mielnik', dm: 'dm003', data: '11/15/2023', email: 'ymielnik0@kickstarter.com', item: 'caneca 4', quantidade: 1, ca: 929670, matricula: 2178, valor: 0.65 },
        { id: 2, nome: 'Elsy MacDermid', dm: 'dm004', data: '4/14/2024', email: 'emacdermid1@uiuc.edu', item: 'caneca 2', quantidade: 8, ca: 119151, matricula: 9229, valor: 0.57 },
        { id: 3, nome: 'Morgan Sive', dm: 'dm003', data: '8/29/2021', email: 'msive2@storify.com', item: 'caneca 4', quantidade: 7, ca: 539485, matricula: 5951, valor: 0.78 },
        { id: 4, nome: 'Mohammed Janaszkiewicz', dm: 'dm005', data: '7/10/2023', email: 'mjanaszkiewicz3@example.com', item: 'caneca 3', quantidade: 6, ca: 820260, matricula: 5594, valor: 0.41 },
        { id: 5, nome: 'Prent Gallagher', dm: 'dm005', data: '4/7/2022', email: 'pgallagher4@blinklist.com', item: 'caneca 4', quantidade: 5, ca: 892485, matricula: 3552, valor: 0.8 },
        { id: 6, nome: 'Brewer Orfeur', dm: 'dm002', data: '5/27/2023', email: 'borfeur5@imdb.com', item: 'caneca 4', quantidade: 1, ca: 185102, matricula: 3247, valor: 0.77 },
        { id: 7, nome: 'Angela Isbell', dm: 'dm004', data: '8/5/2025', email: 'aisbell6@tripadvisor.com', item: 'caneca 1', quantidade: 1, ca: 978084, matricula: 7624, valor: 0.38 },
        { id: 8, nome: 'Osmond Byles', dm: 'dm005', data: '10/19/2021', email: 'obyles7@dmoz.org', item: 'caneca 3', quantidade: 0, ca: 551495, matricula: 6721, valor: 0.52 },
        { id: 9, nome: 'Yasmeen Imorts', dm: 'dm002', data: '11/6/2025', email: 'yimorts8@flavors.me', item: 'caneca 5', quantidade: 9, ca: 259658, matricula: 1860, valor: 0.89 },
        { id: 10, nome: 'Faythe Berger', dm: 'dm003', data: '5/19/2020', email: 'fberger9@edublogs.org', item: 'caneca 3', quantidade: 5, ca: 346378, matricula: 8904, valor: 0.63 },
        { id: 11, nome: 'Pammie Risbie', dm: 'dm005', data: '2/5/2020', email: 'prisbiea@sphinn.com', item: 'caneca 2', quantidade: 6, ca: 139989, matricula: 3419, valor: 0.37 },
        { id: 12, nome: 'Misti Crayden', dm: 'dm001', data: '7/23/2025', email: 'mcraydenb@sciencedirect.com', item: 'caneca 1', quantidade: 5, ca: 630364, matricula: 7744, valor: 0.6 },
        { id: 13, nome: 'Dex Lacrouts', dm: 'dm003', data: '7/12/2023', email: 'dlacroutsc@cnet.com', item: 'caneca 3', quantidade: 3, ca: 257340, matricula: 8696, valor: 0.23 },
        { id: 14, nome: 'Mort Halhead', dm: 'dm002', data: '9/8/2020', email: 'mhalheadd@jugem.jp', item: 'caneca 5', quantidade: 4, ca: 462180, matricula: 3124, valor: 0.04 },
        { id: 15, nome: 'Rusty McKinless', dm: 'dm003', data: '12/17/2021', email: 'rmckinlesse@google.es', item: 'caneca 3', quantidade: 8, ca: 214540, matricula: 8701, valor: 0.21 },
        { id: 16, nome: 'Anabal Starten', dm: 'dm001', data: '11/15/2021', email: 'astartenf@youtube.com', item: 'caneca 2', quantidade: 6, ca: 61682, matricula: 3546, valor: 0.9 },
            ...
            <div class="grid mx-1 px-1 mt-2">
                <div class="p-0 m-0 p-fluid formgrid grid col-12" v-if="show">
                    ...
                    <div class="field lg:col-3 md:col-6 sm:col-6">
                        ...
                        <Dropdown class="drop" v-model="relatorio.dm" :options="formatedDMOptions" optionLabel="label" optionValue="value" />
                    </div>
                    <div class="field lg:col-3 md:col-6 sm:col-6">
                        <label for="planta">Planta:</label>
                        <Dropdown class="drop" v-model="relatorio.id_planta" :options="formatedPlantaOptions" optionLabel="label" optionValue="value" />
                    </div>
                    <div class="field lg:col-3 md:col-6 sm:col-6">
                        <label for="perfil">Centro de Custo:</label>
                        <Dropdown class="drop" v-model="relatorio.id_centro_custo" :options="formatedCentroCustoOptions" optionLabel="label" optionValue="value" />
                    </div>
                    <div class="field lg:col-3 md:col-6 sm:col-6">
                        <label for="perfil">Setor:</label>
                        <Dropdown class="drop" v-model="relatorio.id_setor" :options="formatedSetorOptions" optionLabel="label" optionValue="value" />
                    </div>
                    <div class="field lg:col-3 md:col-6 sm:col-6">
                        <label for="perfil">Funcionário:</label>
                        <Dropdown class="drop" v-model="relatorio.id_funcionario" :options="formatedFuncionarioOptions" optionLabel="label" optionValue="value" />
                    </div>
                    <div class="field lg:col-3 md:col-6 sm:col-6">
                ...
                <div class="datatable-wrapper">
                    <DataTable
                        ...
                        :globalFilterFields="['id', 'dm', 'data', 'matricula', 'nome', 'email', 'item', 'qtd', 'ca', 'valor']"
